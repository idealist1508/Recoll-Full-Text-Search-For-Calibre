...
from calibre_plugins.recoll_fulltext_search.main import RecollFulltextSearchDialog

class RecollFulltextSearchPlugin(InterfaceAction):
    ...
    def show_dialog(self):
        ...
        d = RecollFulltextSearchDialog(self.gui, self.qaction.icon(), do_user_config)
        d.show()
